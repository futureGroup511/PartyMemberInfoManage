...
<link rel="stylesheet" href="${rootPaht }css/manage/uploadvideo.css" />
</head>
...
<div class="first">
	<div class="nameone">
    	<div class="row">
        	<div class="col-lg-2 col-lg-offset-1 col-md-2 col-md-offset-1 col-xs-3 col-xs-offset-1">
        		上传本地视频
            </div>
        </div>
    </div>
    ...
    <div class="partone">
        ...
        <div class="row">
            ...
            <div class="col-lg-1 col-lg-offset-2 col-md-1 col-md-offset-2 col-xs-2 col-xs-offset-2">
            	视频描述：
            </div>
...
<div class="second">
    ...
    <div class="parttwo">
        <div class="row">
            <div class="col-lg-3 col-lg-offset-1 col-md-4 col-md-offset-1 col-xs-5 col-xs-offset-1">
                <div class="row">
            	视频名字：<input name="redVideo.name" type="text" class="navbar-link">
                </div>
                 <div class="row">
            	视频链接：<input name="redVideo.videoUrl" type="text" class="navbar-link">
                </div>
            </div>
            <div class="col-lg-1 col-lg-offset-2 col-md-1 col-md-offset-2 col-xs-2 col-md-offset-2">
            	视频描述：
            </div>
            <div class="col-lg-4 col-md-5 col-xs-5">
            	<textarea rows="5" cols="30" name="redVideo.description"  placeholder="视频描述"></textarea>
            </div>
        </div>
        <div class="row">
         	<div class="col-lg-2 col-lg-offset-1 col-md-2 col-md-offset-1 col-xs-3 col-xs-offset-1">
