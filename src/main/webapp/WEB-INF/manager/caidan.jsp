		...
		<div class="leftsidebar_box">
			...
			<dl class="system_log">
				<dt onClick="changeImage()">
					<img src="${rootPath }images/select_xl01.png">书记管理
				</dt>
				<dd>
					<a target="main" href="${rootPath }manage/partSecretary_add">增加书记</a>
				</dd>
				<dd>
			...
			<dl class="custom">
				<dt onClick="changeImage()">
					<img src="${rootPath }images/select_xl01.png">党员管理
				</dt>
				<dd>
					<a target="main" href="${rootPath }manage/partMember_add">增加党员</a>
				</dd>
				<dd>
					<a target="main" href="${rootPath }manage/partMember">管理党员</a>
				</dd>
			</dl>
			...
			<dl class="channel">
				...
				<dd>
					<a target="main" href="${rootPath }manage/uploadVideo">上传视频</a>
				</dd>
				<dd>
					<a target="main" href="${rootPath }manage/manageVideo">管理视频</a>
				</dd>
			</dl>
			<dl class="channel">
				<dt>
