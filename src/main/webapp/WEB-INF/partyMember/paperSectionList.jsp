...
<body>
	...
	<div id="body">
		<div id="body-one">
			<p>
				<img src="${rootPath}images/topimg.png"> <span>您的位置：<a href="${rootPath}party/partyLogin.action">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="${rootPath }party/partyMemberAction_getResPaper.action">学习园地</a>&nbsp;&nbsp;>&nbsp;&nbsp;${paper.paperType}</span>
			</p>
		</div>
		<div id="body-two">
			<ol>
