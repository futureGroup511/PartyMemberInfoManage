...
<body>
	...
	<div id="body">
		<div id="body-one">
			<p>
				<img src="${rootPath}images/topimg.png"> <span>您的位置：<a href="${rootPath}party/partyLogin.action">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="${rootPath}party/partyMemberAction_onlineSelfTest.action">在线自测</a>&nbsp;&nbsp;>&nbsp;&nbsp;测试结果</span>
			</p>
		</div>		
		<div id="body-big">			
			<div id="body-three">
