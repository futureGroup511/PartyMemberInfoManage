...
<body>
	...
	<div class="body-three">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-xs-3">
				<img src="${rootPath}images/body-one.jpg">
				<p>周恩来的非洲十国之行</p>
			</div>
			<div class="col-lg-3 col-md-3 col-xs-3">
				<img src="${rootPath}images/body-two.jpg">
				<p>周恩来的非洲十国之行</p>
			</div>
			<div class="col-lg-3 col-md-3 col-xs-3">
				<img src="${rootPath}images/body-four.jpg">
				<p>周恩来的非洲十国之行</p>
			</div>
			<div class="col-lg-3 col-md-3 col-xs-3">
				<img src="${rootPath}images/body-five.jpg">
				<p>周恩来的非洲十国之行</p>
			</div>
		</div>
	</div>
	...
	<script src="${rootPath}jquery-2.2.3.min.js"></script>
